...
function fetchData() {
	...
	FetchPending = $.ajax({ url: Endpoint + '/data/aircraft.json',
                                timeout: 5000,
                                cache: false,
                                dataType: 'json' });
...
function initialize() {
	...
	$("#infoblock_name").text('');
        ...
        // with initialization
        $.ajax({ url:  Endpoint + '/data/receiver.json',
                 timeout: 5000,
                 cache: false,
                 dataType: 'json' })
...
function load_history_item(i) {
        ...
        $.ajax({ url:  Endpoint + '/data/history_' + i + '.json',
                 timeout: 5000,
                 cache: false,
                 dataType: 'json' })
...
function initialize_map() {
	...
	$(function ()
  	{
    	   $.ajax({
      	       url: Endpoint + '/sql/sql-best-ranges.php',
    	       data: "",
   	       dataType: 'json',
